...
interface Props {
  ...
  onAddProvider: (p: { name: string; model: string }) => void;
  onBack: () => void;
}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {status === 'valid' && (
            <p style={{ color: '#22c55e', fontSize: '13px' }}>✓ Provider added successfully</p>
          )}
          {status === 'invalid' && (
            <p style={{ color: '#ef4444', fontSize: '13px' }}>✗ Invalid API key</p>
          )}
        </div>
        {providers.length > 0 && (
            ...
            {providers.map((p, i) => (
              ...
              >
                <div>
                  ...
                  <span style={{ fontSize: '12px', color: '#8b8ba7', marginLeft: '8px' }}>
                    {p.model}
                  </span>
                </div>
                <span

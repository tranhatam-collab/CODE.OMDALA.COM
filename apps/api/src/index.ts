...
import { initializeProviders, getProvider } from './ai/providers/registry';
...
const app = new Hono<{ Bindings: { OPENAI_API_KEY: string; ANTHROPIC_API_KEY: string; CLOUDFLARE_API_TOKEN: string; CLOUDFLARE_ACCOUNT_ID: string } }>();
...
const init = (c: any) => initializeProviders({

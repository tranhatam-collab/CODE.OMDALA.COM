          ...
          {[
            ...
            <a
              ...
              style={{
                padding: '8px 12px',
                borderRadius: '6px',
                color: href === '/code' ? '#3b82f6' : '#e2e8f0',
                background: href === '/code' ? '#3b82f620' : 'transparent',
                textDecoration: 'none',
                fontSize: '14px',
              }}
            >
      ...
      <main style={{ flex: 1, padding: '32px', overflow: 'auto' }}>
        ...
        >
          {[
            ...
            >
              <p style={{ fontSize: '12px', color: '#8b8ba7', textTransform: 'uppercase' }}>
                {label}
              </p>
          ...
          >
            {mockProjects.map((p) => (
              ...
              >
                ...
                <p style={{ fontSize: '12px', color: '#8b8ba7' }}>
                  {p.path} • {p.branch}
                </p>
                <p style={{ fontSize: '11px', color: '#4a4a68', marginTop: '8px' }}>
            ...
            {mockSessions.map((s) => (
              ...
              >
                <div>
                  ...
                  <span style={{ fontSize: '12px', color: '#8b8ba7', marginLeft: '12px' }}>
                    {s.model}
                  </span>
                </div>
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: '4px',
                      fontSize: '11px',
                      background: s.status === 'active' ? '#22c55e20' : '#4a4a68',
                      color: s.status === 'active' ? '#22c55e' : '#8b8ba7',
                    }}
                  >
                    {s.status}
                  </span>

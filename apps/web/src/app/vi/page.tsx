...
export const metadata: Metadata = {
  ...
  description:
    'OMCODE là workspace viết code bằng AI cho developer trên Mac. Hỗ trợ nhiều provider, local-first, kiểm soát lệnh an toàn và workflow repo-aware.',
  openGraph: {
    title: 'OMCODE — Viết code với AI, nhưng kiểm soát thật',
    description:
      'AI-native coding workspace cho developer trên Mac. Đa provider, local-first, mã nguồn mở.',
    type: 'website',
  ...
  return (
    <main>
      <section style={hero}>
        ...
        <div style={ctaGroup}>
          <a href="/vi/download" style={primaryBtn}>
            Tải cho Mac
          </a>
      ...
      <section style={section}>
        ...
        <p style={sectionText}>
          Trải nghiệm viết code nhanh nhất bắt đầu từ local. Truy cập filesystem trực tiếp, hiệu
          năng native, và tích hợp mượt mà với workflow phát triển hiện có của bạn.
        </p>
      </section>
      <section style={section}>
        <h2 style={sectionTitle}>Hỗ trợ đa Provider</h2>
        <p style={sectionText}>
          OpenAI, Anthropic, Cloudflare Workers AI — điều hướng thông minh theo loại tác vụ, chi phí
          và khả năng. Không bị khóa vào một model duy nhất.
        </p>
      </section>
      <section style={section}>
        <h2 style={sectionTitle}>Workflow Local-first</h2>
        <p style={sectionText}>
          Code của bạn ở trên máy cho đến khi bạn chủ động gửi lên AI. Toàn quyền kiểm soát những gì
          được chia sẻ, khi nào, và với provider nào.
        </p>
      </section>
      <section style={section}>
        <h2 style={sectionTitle}>Quy trình AI có kiểm soát</h2>
        <p style={sectionText}>
          Không phải chat box. Một workspace thật: mở project, đọc repo, sửa file, chạy lệnh an
          toàn, review diff, và áp patch có phê duyệt.
        </p>
      </section>
      <section style={section}>
        <h2 style={sectionTitle}>Mã nguồn mở</h2>
        <p style={sectionText}>
          Xây dựng công khai. Clone, chạy, fork và đóng góp. Kiến trúc minh bạch, lộ trình rõ ràng,
          và phát triển hướng cộng đồng.
        </p>
      </section>
      <section style={section}>
        <h2 style={sectionTitle}>Bảo mật & Riêng tư</h2>
        <p style={sectionText}>
          API key lưu an toàn. Lệnh cần phê duyệt. Dữ liệu nhạy cảm được xóa trước khi gửi lên
          provider. Nhật ký kiểm toán cho mọi thao tác.
        </p>
      </section>
      <footer style={footer}>

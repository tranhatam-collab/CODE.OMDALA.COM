...
export const CAPABILITY_REGISTRY: McpToolDefinition[] = [
  {
    ...
    server: 'github',
    type: 'read',
    description: 'Clone or fetch repository metadata',
    trustLevel: 'high',
  ...
  },
  {
    ...
    server: 'github',
    type: 'read',
    description: 'List branches with metadata',
    trustLevel: 'high',
    requiresApproval: false,
  },
  {
    ...
    server: 'github',
    type: 'read',
    description: 'Read file content at path',
    trustLevel: 'high',
    requiresApproval: false,
  },
  {
    ...
    server: 'github',
    type: 'read',
    description: 'List files in directory tree',
    trustLevel: 'high',
    requiresApproval: false,
  },
  {
  ...
  },
  {
    ...
    server: 'repo-map',
    type: 'read',
    description: 'Generate file tree with metadata',
    trustLevel: 'high',
    requiresApproval: false,
  },
  {
  ...
  },
  {
    ...
    server: 'docs',
    type: 'write',
    description: 'Generate docs from code or specs',
    trustLevel: 'medium',
    requiresApproval: true,
  },
  {
  ...
  },
  {
    ...
    server: 'docs',
    type: 'read',
    description: 'Check docs for broken links',
    trustLevel: 'medium',
    requiresApproval: false,
  },
  {
    ...
    server: 'docs',
    type: 'write',
    description: 'Translate docs between vi/en',
    trustLevel: 'medium',
    requiresApproval: true,
  },
  {
    ...
    server: 'api-contract',
    type: 'read',
    description: 'Read existing API contracts',
    trustLevel: 'medium',
    requiresApproval: false,
  },
  {
    ...
    server: 'api-contract',
    type: 'write',
    description: 'Generate API contract from code',
    trustLevel: 'medium',
    requiresApproval: true,
  },
  {
    ...
    server: 'api-contract',
    type: 'read',
    description: 'Validate implementation against contract',
    trustLevel: 'medium',
    requiresApproval: false,
  },
  {
  ...
  },
  {
    ...
    server: 'design-token',
    type: 'write',
    description: 'Update design token values',
    trustLevel: 'medium',
    requiresApproval: true,
  },
  {
    ...
    server: 'roadmap',
    type: 'read',
    description: 'Read current roadmap',
    trustLevel: 'medium',
    requiresApproval: false,
  },
  {
    ...
    server: 'roadmap',
    type: 'write',
    description: 'Update roadmap items',
    trustLevel: 'medium',
    requiresApproval: true,
  },
];
